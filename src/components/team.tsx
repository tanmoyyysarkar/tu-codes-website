    ...
    const teamMembers = [
        ...
        },
        {
            ...
            socials: {
                ...
                github: "https://github.com/YASHSHARMAOFFICIALLY",
                twitter: "#",
            },
        },
        {
            ...
            socials: {
                ...
                github: "https://github.com/Areesha-Khan1411",
                twitter: "#",
            },
        },
        {
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    {teamMembers.map((member, index) => (
                        <div
                            key={index}
                            className="bg-white rounded-3xl p-8 text-center hover:shadow-xl transition-all border border-gray-100 hover:border-gray-200 group"
                        >
                            ...
                            {/* Quote */}
                            <p className="text-gray-600 text-sm italic mb-6 min-h-[40px]">
                                "{member.quote}"
                            </p>
